...
const Trabajos = () => {
  ...
  return (
    <Fragment>
      <h1 style={{ marginBottom: '10px' }}>NOSOTROS</h1>
          ...
          <Card style={{ margin: '0 10px' }}>
            ...
            <div style={{ margin: '20px 10px' }}>
              ...
              <Avatar
                ...
                className={classes.avatar}
              />
              <h4>REYMUNDO LOPEZ</h4>
              <p>
                3 años trabajando para empresa privada. 2 años trabajando en
                hotel palacio. Tegnólogico de Puerto Vallarta
              </p>
            </div>
          </Card>
        </Grid>
        <Grid item xs={12} sm={4}>
          <Card style={{ margin: '0 10px' }}>
            ...
            <div style={{ margin: '20px 10px' }}>
              ...
              <h4>LUIS FELIPE</h4>
              <p>
                5 años trabajando en CFE. 2 años trabajando para cadena de
                restaurantes. Universidad Vizcaya
              </p>
            </div>
          </Card>
        </Grid>
